    ...
    return(
		<div className="grid place-items-center my-32 md:my-20">
			<div className=' flex flex-wrap justify-around items-center gap-10'>
				<h2 className='font-semibold text-xl md:text-2xl text-center'> En N-INNOVATIONS BIOSUPLLY BOL <br className="hidden md:inline-block" /> suministramos material para: 
				</h2>
