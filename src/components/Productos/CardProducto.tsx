...
export default function CardProducto({ nombre, mainImage, marca, descripcion }: CardProductoProps) {
    ...
    return(
        <>
            {/* Card */}
            <motion.div
                className="flex flex-col bg-gray-100 w-[300px] md:w-[330px] h-[400px] md:h-[380px] p-6 rounded-2xl shadow-md hover:bg-primary hover:text-white hover:scale-110 duration-300 break-words whitespace-normal"
                variants={entryProd}
                initial="offscreen"
                ...
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50"
                    ...
                    <div className="bg-white w-[95%] h-[90vh] p-6 rounded-lg shadow-lg relative flex flex-wrap justify-around items-center">
                        ...
                        <div className='flex-center flex-col md:pl-4'>
                            ...
                            <div className='overflow-y-auto w-full max-h-[200px] md:max-h-[400px] p-4 prose prose-xl'>
                                <h3>Descripción:</h3>
