...
const Hero: React.FC = () => {
    return (
        <section
            id="hero"
            className="relative flex items-center justify-center px-5 h-[66vh] md:h-[80vh] bg-[url('/images/banner.webp')] bg-cover bg-center bg-no-repeat bg-opacity-10 text-5xl font-bold text-white"
        >
